/*
The Contract is Owned By: https://moonfork.com/
*/
...
contract moonfork is Context, IBEP20, Ownable, ReentrancyGuard {
    ...
    string public constant name     = "moonfork";
    string public constant symbol   = "moonfork";
